  ...
  return (
    <div className="relative flex min-h-screen w-full">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-0 right-1/4 h-[500px] w-[500px] rounded-full bg-purple-500/10 blur-3xl" />
        <div className="absolute bottom-0 left-1/4 h-[400px] w-[400px] rounded-full bg-primary/10 blur-3xl" />
      </div>

      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 bg-linear-to-br from-purple-500/5 via-background to-primary/10 border-r border-border/40">
        <div>
          <Link
            to="/"
        ...
        >
          ...
          <div className="space-y-4 max-w-md">
            <h1 className="text-4xl font-bold tracking-tight">
              Start managing your SaaS today
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Join thousands of developers who trust SaasGuard to manage their
              feature flags, permissions, and usage tracking.
            </p>
          </div>
      ...
      <div className="flex w-full lg:w-1/2 flex-col items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <p className="text-muted-foreground mt-2">
            Get started with SaasGuard for free
          </p>
        </motion.div>
