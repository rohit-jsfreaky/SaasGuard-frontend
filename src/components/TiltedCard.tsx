...
export default function TiltedCard({
  ...
  className = '',
  children,
  showMagneticEffect: _showMagneticEffect = false
}: TiltedCardProps) {
  ...
  return (
    <figure
      ref={ref}
      className={`relative w-full h-full [perspective:800px] flex flex-col items-center justify-center ${className}`.trim()}
      style={{
